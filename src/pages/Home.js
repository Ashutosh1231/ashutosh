      ...
      <div class="container-fluid p-0">
        ...
        <section class="resume-section" id="about">
          <div class="resume-section-content">
            <h1 class="mb-0">
              Ashutosh
              <span class="text-primary">Kasat</span>
            </h1>
            <div class="subheading mb-5">
              Shivkrupa Udyog · MIDC Phase 2, Akola, MH · (+91) 7276637981 · 
              <a href="mailto:akasat54e@gmail.com">akasat54@gmail.com</a>
            </div>
            <p class="lead mb-5">
            Aspiring to secure a challenging UI Developer role, creating immersive user interfaces through cutting-edge
 front-end development, while actively pursuing professional growth and remaining at the forefront of emerg
